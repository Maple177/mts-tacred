...
def get_args():
    ...
    parser.add_argument("--mask_perc",type=float,default=0.15,help="percentage of randomly masking syntactic targets.")
    ...
    parser.add_argument("--run_id",type=str,help="use for distinguishing different jobs.")

    group = parser.add_argument_group('--training_options')
    group.add_argument("--batch_size", default=32, type=int)
    group.add_argument("--coef",type=float,default=1.0,help="weighting coefficient on syntactic loss.")
    ...
    group.add_argument("--ensemble_size",type=int,default=5,help="number of models for ensembling.")
